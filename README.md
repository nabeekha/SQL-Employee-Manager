...
To install this application, start by installing Node.js. From here, leverage the node package library by running "npm install i" in your command line. Additionally, please install the inquirer package by using the command "npm i inquirer@8.2.4"
