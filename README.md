...
Please see a photo below of the example results: 
![Example Code](./assets/working-cms.png)

Link to demonstration video:
https://youtu.be/1lVpRdYCvo4 

## Credits

No collaborators were involved in this. This code does leverage Node.js inquirer packages, mysql2 and the npm console table outline below:
MySQL2:
